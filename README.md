...
The Markdown file is the source for generating the Word document, whose styling and formatting are then incorporated with the text into the EPUB and PDF versions, which are generated by Pandoc from the .docx file. 
