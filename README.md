...
The runbook template is provided in one source format:

| File | Format | Best for |
|------|--------|----------|
| `WP-Operations-Runbook.md` | Markdown | Git repositories, wikis, version-controlled documentation |

The Markdown file is the canonical source for this project. PDF, DOCX, and EPUB artifacts are intentionally not generated or versioned in this repository.

The document is organized into 11 sections plus appendices:
...
1. **Use the Markdown source.** Use `WP-Operations-Runbook.md` as the maintained source of truth for your operational documentation workflow.
